...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "MALVIN-XD~Fl4BiYrA#MeHBaWXEjj4XZdawZjYwFZrskRuCGcLil7qY1-LWaEA",
// add your Session Id ,session id starts with MALVIN-XD~

PREFIX: process.env.PREFIX || ".",
// add your prifix for bot

BOT_NAME: process.env.BOT_NAME || "✦ DEW xᴅ v2✦",
// add bot name here for menu

CUSTOM_REACT: process.env.CUSTOM_REACT || "true",
// make this true for custum emoji react   

STICKER_NAME: process.env.STICKER_NAME || "✦DEW-XD✦",
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "94760683496",
// add your bot owner number

OWNER_NAME: process.env.OWNER_NAME || "DEW ID🪀✦",
// add bot owner name
...
DEV: process.env.DEV || "94760683496",
